...
const Ogre::String HlmsParticleListener::InsertEmitterAffectors_PieceKey = "insert_emitter_affectors";
const Ogre::String HlmsParticleListener::InsertParticleAffectors_PieceKey = "insert_particle_affectors";
...
void HlmsParticleListener::generateEmitterCoreDataAffectorsCode(Ogre::String& resultPiece, const std::vector<const GpuParticleAffector*>& affectorList)
{
    resultPiece = "// *** Autogenerated piece with order of affectors inside EmitterCoreData.";
    for (size_t i = 0; i < affectorList.size(); ++i) {
        const GpuParticleAffector* affector = affectorList[i];
        resultPiece += "\n@insertpiece(" + affector->getAffectorProperty() + "_emitter)";
    }
    resultPiece += "\n\t// Autogenerated piece with order of affectors inside EmitterCoreData. ***";
}

void HlmsParticleListener::generateParticleDataAffectorsCode(Ogre::String& resultPiece, const std::vector<const GpuParticleAffector*>& affectorList)
{
    resultPiece = "// *** Autogenerated piece with order of affectors inside Particle.";
    for (size_t i = 0; i < affectorList.size(); ++i) {
        const GpuParticleAffector* affector = affectorList[i];
        resultPiece += "\n@insertpiece(" + affector->getAffectorProperty() + "_particle)";
    }
    resultPiece += "\n\t// Autogenerated piece with order of affectors inside Particle. ***";
}
...
void HlmsParticle::calculateHashForPreCreate(Ogre::Renderable* renderable, Ogre::PiecesMap* inOutPieces) {
    ...
    if( customParams.find( GpuParticleSystemWorld::RenderableTypeId ) != customParams.end() )
    {
        ...
        {
            Ogre::String pieceKey = HlmsParticleListener::InsertEmitterAffectors_PieceKey;
        ...
        // Data will be uploaded to gpu in the same order.
        {
            Ogre::String pieceKey = HlmsParticleListener::InsertParticleAffectors_PieceKey;
