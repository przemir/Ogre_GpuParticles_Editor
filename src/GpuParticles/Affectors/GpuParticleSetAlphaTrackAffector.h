...
public:
    ...
    virtual GpuParticleAffector* clone() const override { return OGRE_NEW GpuParticleSetAlphaTrackAffector(*this); }

    virtual AffectorType getType() const override { return AFFECTOR_SET_ALPHA_TRACK; }
